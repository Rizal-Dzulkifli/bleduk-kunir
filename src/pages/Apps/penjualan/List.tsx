    ...
    const [items, setItems] = useState([
        {
            ...
            tgl_jatuhtempo: '20 Dec 2020',
            total_harga: '28.000.000',
        ...
        },
        {
            ...
            tgl_jatuhtempo: '23 Dec 2020',
            total_harga: '30.000.000',
        ...
        },
        {
            ...
            tgl_jatuhtempo: '27 Dec 2020',
            total_harga: '40.000.000',
        ...
        },
        {
            ...
            tgl_jatuhtempo: '29 Dec 2020',
            total_harga: '25.000.000',
            status: { tooltip: 'Selesai', color: 'success' },
        },
        {
            id: 6,
            ...
            tgl_jatuhtempo: '31 Dec 2020',
            total_harga: '22.000.000',
            status: { tooltip: 'Produksi', color: 'warning' },
        },
        {
            id: 7,
            ...
            tgl_jatuhtempo: '02 Jan 2021',
            total_harga: '35.000.000',
            status: { tooltip: 'Dikirim', color: 'info' },
        },
        {
            id: 8,
            ...
            tgl_jatuhtempo: '04 Jan 2021',
            total_harga: '45.000.000',
            status: { tooltip: 'Belum Dibayar', color: 'danger' },
        },
        {
            id: 9,
            ...
            <div className="invoice-table">
                <div className="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                    <div className="flex items-center gap-2">
                        ...
                        <Link to="/apps/penjualan/add" className="btn btn-primary gap-2">
                            <IconPlus />
                            Add New
                        </Link>
                    </div>
                        ...
                        columns={[
                            {
                                ...
                                sortable: true,
                                render: ({ no_pemesanan }) => (
                                    <NavLink to="/apps/penjualan/preview">
                            ...
                            {
                                accessor: 'tgl_jatuhtempo',
                                sortable: true,
                            },
                            {
                                accessor: 'total_harga',
                                sortable: true,
                                render: ({ total_harga}) => <div >{`RP ${total_harga}`}</div>,
                            },
                            {
                                accessor: 'status',
                                sortable: true,
                            ...
                            },
                            {
                                ...
                                render: ({ id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        <NavLink to="/apps/penjualan/edit" className="flex hover:text-info">
