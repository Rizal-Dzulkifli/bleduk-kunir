    ...
    const [events, setEvents] = useState<any>([
        {
            ...
            className: 'danger',
            description: 'Deskripsi produksi',
        },
        {
            id: 2,
            title: 'Pesanan',
                                                ...
                                                <div className="mt-3">
                                                    <label className="inline-flex cursor-pointer ltr:mr-3 rtl:ml-3">
                                                        <input
                                                            ...
                                                            name="type"
                                                            value="produksi"
                                                            checked={params.type === 'produksi'}
                                                            onChange={(e) => setParams({ ...params, type: e.target.value })}
                                                        />
                                                        <span className="ltr:pl-2 rtl:pr-2">Produksi</span>
                                                    </label>
                                                    <label className="inline-flex cursor-pointer ltr:mr-3 rtl:ml-3">
                                                        <input
                                                            type="radio"
                                                            ...
                                                            name="type"
                                                            value="pesanan"
                                                            checked={params.type === 'pesanan'}
                                                            onChange={(e) => setParams({ ...params, type: e.target.value })}
                                                        />
                                                        <span className="ltr:pl-2 rtl:pr-2">Pesanan</span>
                                                    </label>
                                                    <label className="inline-flex cursor-pointer ltr:mr-3 rtl:ml-3">
                                                        <input
                                                            type="radio"
                                                            ...
                                                            name="type"
                                                            value="pengiriman"
                                                            checked={params.type === 'pengiriman'}
                                                            onChange={(e) => setParams({ ...params, type: e.target.value })}
                                                        />
                                                        <span className="ltr:pl-2 rtl:pr-2">Pengiriman</span>
                                                    </label>
                                                </div>
                                            </div>
